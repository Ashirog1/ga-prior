...
cpp_folder = os.path.join(root)
cpp_filename = "ga-priority"
...
# TODO: change to dynamic rooting

input_folder = "/home/only_u/Desktop/permanent/rs/drone/ga-priority/Data/data_v1"
output_file = os.path.join(root, r"result/data_v1_result.csv")
...
def worker():
    while True:
        ...
        with open(input_path) as infile:
            ...
            print(input_file, result.stdout)
